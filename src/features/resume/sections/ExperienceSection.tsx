        ...
        <div className="flex flex-col">
          <div>
            ...
            <h3 className="text-3xl">
              <ExternalLink
                className="border-underline"
                href="https://www.cublick.com/솔루션/큐브릭서비스/"
              >
              ...
              <div>
                ...
                <ul className="ml-8">
                  <li className="list-disc">
                    ...
                    <ul className="ml-8">
                      <li className="list-disc">
                        사용자 action 중심, 절차지향 방식{" "}
                        <ArrowRightIcon className="inline size-4" /> 디자인
                        element 중심, 선언적 OOP 방식
                      </li>
                  ...
                  <li className="list-disc">
                    ...
                    <ul className="ml-8">
                      <li className="list-disc">
                        기존 관리도구에서 사용되던 디자인 CRUD api 연동
                      </li>
                      <li className="list-disc">
                        디자인 프레젠테이션 api 연동
                      </li>
                  ...
                  <li className="list-disc">
                    기존 UI에 시맨틱 태그 및 flex, grid 기반 반응형 디자인 적용
                  </li>
                </ul>
              </div>
              <div>
                ...
                <ul className="ml-8">
                  <li className="list-disc">
                    캔버스에서 undo redo할 때, 컴포넌트에 관계없이 serdes 가능
                  </li>
                  <li className="list-disc">
                    WeekMap을 통해 image 컴포넌트 캐싱{" "}
                    <ArrowRight className="inline size-4" /> undo redo 속도 향상
                  </li>
                  <li className="list-disc">
                    api 호출 함수와 react-query hook을 decouple{" "}
                    <ArrowRight className="inline size-4" /> api 변경에 유연하게
                    대처가능
                  </li>
                </ul>
              </div>
            ...
            <CollapsibleContent className="mt-8 space-y-8 md:mt-10 md:space-y-10">
              <div>
                ...
                <ul className="ml-8">
                  ...
                  <li className="list-disc">
                    React 컴포넌트 마이그레이션 (class{" "}
                    <ArrowRight className="inline size-4" /> func)
                  </li>
                  <li className="list-disc">
                    통합 모달처리 react hook(useModal) 개발 및 적용
                  </li>
                </ul>
              </div>
              <div>
                ...
                <ul className="ml-8">
                  <li className="list-disc">
                    os 및 버전별 빌드 시나리오를 readme에 정리, 빌드실패로 인한
                    소통비용 감소
                  </li>
                  <li className="list-disc">
                    300개 이상의 컴포넌트를 함수 컴포넌트로 다시 작성{" "}
                    <ArrowRight className="inline size-4" /> 기존 컴포넌트
                    확장성 재고 및 통폐합
                  </li>
                  <li className="list-disc">
                    hook을 통한 모달처리 일관성 제공{" "}
                    <ArrowRight className="inline size-4" /> css z-index 의존
                    제거
                  </li>
                </ul>
              </div>
