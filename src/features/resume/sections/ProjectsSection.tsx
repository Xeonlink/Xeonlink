...
export function ProjectsSection() {
  return (
    <Section className="space-y-10" id="projects" title="PROJECTS">
      {/* ReFolder */}
        ...
        <div className="flex flex-col">
          <div>
            ...
            <h3 className="text-3xl">
              <ExternalLink
                ...
                href="https://github.com/Xeonlink/re-folder"
              >
                ReFolder
              </ExternalLink>
              &nbsp;
            ...
            <div className="mt-1 flex flex-wrap">
              ...
              <Badge
                color="FF4154"
                logo={{ slug: "reactquery", color: "white" }}
              >
                react query
              </Badge>
            ...
            <p className="mt-1 max-w-150 break-keep">
              ReFolder는 사용자가 설정한 규칙에 따라서 정리되지 않은 폴더의
              파일을 정리해주는 프로그램입니다. nodejs watch 기능을 사용하여,
              폴더가 더러워지는 것을 미연에 방지합니다. 자세한 기능은{" "}
          ...
          <Collapsible>
            <CollapsibleTrigger asChild>
              <Button
                className="mt-2 justify-start text-lg"
                variant="outline"
                size="lg"
              >
                도전 과제 및 해결 방법
            ...
            <CollapsibleContent className="mt-8 space-y-8 md:mt-10 md:space-y-10">
              <div>
                <h4 className="text-xl font-bold">도전 과제</h4>
                <ul className="ml-8">
                  <li className="list-disc">
                    electron의 ipc통신은 channel name(string)을{" "}
                    <span className="text-accent">기억하고 사용</span>
                    해야함.
                  </li>
                  <li className="list-disc">
                    channel 이름에 오타가 발생하여,{" "}
                    <span className="text-accent">
                      없는 채널로 요청을 보내는 Human Error
                    </span>
                    가 종종 발생.
                  </li>
                  <li className="list-disc">
                    main process에서의 <span className="text-accent">에러</span>
                    가 renderer process로 전달되지 않음. (예기치 못한 시점에
                    main process가 죽음)
                  </li>
                </ul>
              </div>
              <div>
                ...
                <ImageSwap className="my-2 max-w-150">
                  ...
                  <img
                    ...
                    alt="어떤 ipc가 있는지 타입추론되는 이미지"
                  />
                </ImageSwap>
                <ul className="ml-8">
                  <li className="list-disc">
                    electron의 invoke, handle 함수를 감싸서 channel name이{" "}
                    <span className="text-accent">자동으로 생성</span>되도록
                    설계.
                  </li>
                  <li className="list-disc">
                    <span className="text-accent">
                    ...
                    하여, main process 에러를 renderer까지 전파
                  </li>
                  <li className="list-disc">
                    preload script에{" "}
                    <span className="text-accent">ipc정의만 전달</span>하여,
                    invoke 함수가 런타임에 생성되도록 함.
                  </li>
                </ul>
              </div>
            </CollapsibleContent>
      ...
      <Article>
        ...
        <div className="flex flex-col">
          <div>
            ...
            <p className="mt-1 max-w-150 break-keep">
              한국에서 사용되는 모바일 본인인증, 휴대폰 인증, 민간인증서 인증
              등을 사용할 때 필요한 정보를 자동으로 채워주는 브라우저
              확장프로그램 입니다. 간단한 캡챠이미지는{" "}
              <span className="text-accent">비전 AI</span>를 통해 자동으로
              채워넣습니다. 자세한 기능은{" "}
              <ExternalLink
                className="border-underline"
          ...
          <Collapsible>
            ...
            <CollapsibleContent className="mt-8 space-y-8 md:mt-10 md:space-y-10">
              <div>
                ...
                <ul className="ml-8">
                  <li className="list-disc">
                    기존에는 사용자가 의도적으로 캡챠를 풀어야했음.
                  </li>
                  <li className="list-disc">
                    초기에 tesseract.js를 사용해서 captcha breaking 시도{" "}
                    <ArrowRightIcon className="inline size-4" />{" "}
                    <span className="text-accent">실패 (정확도 30% 미만)</span>
                  </li>
                  <li className="list-disc">
                    모델을 만들더라도 인증밴더가 캡챠를 바꾸면 다시 제작해야하는
                    문제가 있음.
                  </li>
                </ul>
              </div>
              <div>
                ...
                <ul className="ml-8">
                  <li className="list-disc">
                    ...
                    <ExternalLink
                      className="border-underline"
                      href="https://github.com/Xeonlink/kaptch"
                    >
                  ...
                  <li className="list-disc">
                    인증벤더마다 전용 모델을 개발하여,{" "}
                    <span className="text-accent">정확도 99.9% 이상</span> 달성
                  </li>
                  <li className="list-disc">
                    특정 인증벤더의 캡챠가 바뀌더라도 모델 전체를 재학습시키지
                    않아도 됨
                  </li>
                </ul>
              </div>
        ...
        <div className="flex flex-col">
          <div>
            ...
            <h3 className="text-3xl">
              <ExternalLink
                className="border-underline"
                href="https://syncron.ohjimin.com/"
              >
            ...
            <p className="mt-1 max-w-150 break-keep">
              Sync Metronome은 브라우저에서 동작하는{" "}
              <span className="text-accent font-bold">실시간 동기화</span>{" "}
              메트로놈입니다. 호스트의 BPM·박자·재생 상태를 공유하여 연습할 수
              있습니다. 자세한 기능은{" "}
              <ExternalLink
                className="border-underline"
                href="https://github.com/phanzi/WebMetrome"
              >
                <span className="text-accent font-bold">레포지토리</span>
              </ExternalLink>
              를 참고바랍니다.
          ...
          <Collapsible>
            ...
            <CollapsibleContent className="mt-8 space-y-8 md:mt-10 md:space-y-10">
              <div>
                <h4 className="text-xl font-bold">도전 과제</h4>
                <img
                  className="my-2 ml-4 h-52 max-w-150 rounded-xl"
                ...
                <ul className="ml-8">
                  <li className="list-disc">
                    통신 지연이 수 ms 임에도,{" "}
                    <span className="text-accent">수십 ms</span> 동기화 오차가
                    발생함.
                  </li>
                  <li className="list-disc">
                    기기마다 타임라인의 오차가 있거나, 브라우저 API의 한계일
                    것으로 추정함.
                  </li>
                  <li className="list-disc">
                    WebSocket 서버대비 얼마나 시간이 빠르게 흐르고 있는지
                    확인하고 보정해야함.
                  </li>
                </ul>
              </div>
              <div>
                ...
                <ul className="ml-8">
                  <li className="list-disc">
                    <span className="text-accent">네트워크 지연을 고려</span>
                    하여 clock skew를 계산하기 위한 방식을 고안하고, 구현
                  </li>
                  <li className="list-disc">
                    네트워크 및 clock skew 지연을 수십 ms{" "}
                    <ArrowRightIcon className="inline size-4" />{" "}
                    <span className="text-accent">3 ms 이하</span> 로 줄임.
                  </li>
                  <li className="list-disc">
                    <span className="text-accent">NTP 없이</span> 도, clock
                    skew를 계산하고 보정할 수 있도록 설계.
                  </li>
                </ul>
              </div>
            </CollapsibleContent>
      ...
      <Article>
        ...
        <div className="flex flex-col space-y-8 md:space-y-10">
          <div>
            ...
            <p className="mt-1 max-w-150 break-keep">
              prettier-plugin-organize-attributes는 prettier 플러그인으로, html
              like한 코드에서 attributes를 재배치하여 코드를 보기 좋게
              만들어주는 플러그인입니다. 자세한 기능은{" "}
              <ExternalLink
                className="border-underline"
