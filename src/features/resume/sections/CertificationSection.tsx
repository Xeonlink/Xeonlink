import 정보처리기사자격증Image from "@/features/resume/assets/engineer_information_processing_cert.jpeg";
import SQLD자격증Image from "@/features/resume/assets/sqld_cert.png";
