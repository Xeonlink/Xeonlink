...
function RouteComponent() {
  return (
    <main className="mx-auto max-w-4xl space-y-12 px-6 py-20">
      ...
      <section className="space-y-4">
        ...
        <Tabs defaultValue="boolean-state">
          ...
          <TabsContent value="boolean-state">
            <CodeBlock code={BOOLEAN_STATE_MODAL} />
          </TabsContent>
          <TabsContent value="shadcn-modal">
            <CodeBlock code={SHADCN_MODAL} />
          </TabsContent>
          <TabsContent value="dialog-modal">
            <CodeBlock code={DIALOG_MODAL} />
          </TabsContent>
        </Tabs>
        <p className="text-muted-foreground leading-relaxed">
        ...
        <Tabs defaultValue="async callback">
          ...
          <TabsContent value="async callback">
            <CodeBlock code={ASYNC_CALLBACK_MODAL} />
          </TabsContent>
          <TabsContent value="single dialog limit">
            <CodeBlock code={BOOLEAN_STATE_MODAL_WITH_STATE} />
          </TabsContent>
        </Tabs>
        <p className="text-muted-foreground leading-relaxed">
      ...
      <section className="space-y-4">
        <h2 className="text-2xl font-semibold">JSX를 state로</h2>
        <p className="text-muted-foreground leading-relaxed">
      ...
      <section className="space-y-4">
        <h2 className="text-2xl font-semibold">더 나아가기</h2>
        <p className="text-muted-foreground leading-relaxed">
        ...
        <Tabs defaultValue="trigger">
          ...
          <TabsContent value="closer">
            <CodeBlock code={CLOSER} />
          </TabsContent>
          <TabsContent value="example">
            <CodeBlock code={DEMO_EXAMPLE} />
          </TabsContent>
        </Tabs>
      </section>
