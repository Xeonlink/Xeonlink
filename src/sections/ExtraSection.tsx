...
export function ExtraSection() {
  return (
    <Section id="extra" title="기타">
      <Article>
        <ArticleHeader>
          <ArticleTitle href="https://github.com/Xeonlink/kaptch">Kaptch</ArticleTitle>
          <p>
      ...
      <Article>
        <ArticleHeader>
          <ArticleTitle href="https://github.com/Xeonlink/LoanService">LoanService</ArticleTitle>
          <p>
